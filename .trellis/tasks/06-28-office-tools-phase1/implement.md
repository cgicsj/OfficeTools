...
- If direct `.xls` reading cannot meet required metadata and formatting needs, narrow `.xls` to manual `.xlsx` conversion before implementing feature UI around `.xls` support.
