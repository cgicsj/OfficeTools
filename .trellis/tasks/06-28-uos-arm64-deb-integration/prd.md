...
- The packaged app can locate system WPS or show the manual-conversion fallback dialog.
...
- [ ] WPS conversion behavior works or degrades to the required manual-conversion dialog.
